...
export type ReadMode = "vertical" | "horizontal" | "webtoon" | "continuous";

export type ReadDirection = "ltr" | "rtl";

export type NavigateDirection = "next" | "prev";

export type NextDirection = "next" | "prev" | "first" | "last";
...
export type SourcesId = "NTC" | "LHM" | "OTK" | "MNG" | "MGR";
...
export type Status = "In progress" | "Completed" | "On hold" | "Dropped";
...
// gnenres need to be updated to match with the new genres
